...
1.  Copy the `Skills/dataverseCodeApp/SKILL.md` file to:
   ```
   ~/.copilot/skills/dataverseCodeApp/SKILL.md
   ```

Once in place, Copilot will automatically use these skills when you ask it to code-first app dataverse connections.
...
```bash
pac code push --solutionName DataverseDemo
```
